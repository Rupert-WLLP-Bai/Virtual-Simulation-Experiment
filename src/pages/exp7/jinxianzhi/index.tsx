...
import { Formula, FormulaBlock } from "@/components/ui/formula";
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-2xl font-bold mb-6">NPV/IRR 投资评价</h1>

        <div className="bg-white rounded-xl shadow-md p-6 mb-6">
          <h2 className="text-lg font-semibold mb-4">现金流输入</h2>
          <div className="mb-4">
        ...
        <FormulaBlock title="NPV 公式" formula="NPV = \sum_{t=0}^{n} \frac{CF_t}{(1+r)^t}" />
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          <h2 className="text-lg font-semibold mb-4">折现现金流图</h2>
          <LineChart
