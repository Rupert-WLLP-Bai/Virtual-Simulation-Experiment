    ...
    <div className="min-h-screen bg-gray-50 p-6" id="experiment-content">
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold">蒙特卡洛模拟</h1>
          <ExportPDF targetId="experiment-content" filename="蒙特卡洛模拟.pdf" />
        </div>

        {/* 参数配置 */}
        <div className="bg-white rounded-xl shadow-md p-6 mb-6">
          <h2 className="text-lg font-semibold mb-4">模拟参数配置</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <StatisticCard title="均值" value={result.mean} prefix="¥" valueColor="text-blue-600" />
          <StatisticCard title="中位数" value={result.median} prefix="¥" valueColor="text-purple-600" />
          <StatisticCard title="标准差" value={result.std} valueColor="text-orange-600" />
          <StatisticCard
            title="盈利概率"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <StatisticCard title="最小值" value={result.min} prefix="¥" valueColor="text-gray-600" />
          <StatisticCard title="最大值" value={result.max} prefix="¥" valueColor="text-gray-600" />
          <StatisticCard title="5%分位数" value={result.p5} prefix="¥" valueColor="text-gray-600" />
          <StatisticCard title="95%分位数" value={result.p95} prefix="¥" valueColor="text-gray-600" />
        </div>

        {/* 图表 */}
        <div className="bg-white rounded-xl shadow-md p-6">
          <h2 className="text-lg font-semibold mb-4">利润分布直方图</h2>
          {chartData.labels && (
            <LineChart
              title=""
